                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:blogEntryInstance, field:'allowComments')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:blogEntryInstance, field:'created')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="user" action="show" id="${blogEntryInstance?.user?.id}">${blogEntryInstance?.user?.encodeAsHTML()}</g:link></td>
